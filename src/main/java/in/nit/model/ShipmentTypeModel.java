...
public class ShipmentTypeModel {
	...
	public ShipmentTypeModel() {
		System.out.println("ShipmentTypeModel.ShipmentTypeModel()");
	}

	public ShipmentTypeModel(Integer shipId) {
		super();
		this.shipId = shipId;
	}
	...
	public String toString() {
		return "ShipmentTypeModel [shipId=" + shipId + ", shipMode=" + shipMode + ", shipCode=" + shipCode
				+ ", enbShip=" + enbShip + ", shipGrade=" + shipGrade + ", shipDesc=" + shipDesc + "]";
	}
